...
export default function DashboardPage() {
  ...
  return (
    <div className="container w-full mx-auto p-4 pt-20 sm:p-6 lg:p-8 lg:pt-30 flex flex-col md:flex-row gap-6 text-foreground">
      ...
      <button 
        className="px-12 py-3 mt-6 bg-secondary text-secondary-foreground border-border border-2 rounded-lg transition ml-2 flex items-center gap-2"
      ...
      >
        ...
        {/* Owner Card */}
      <div className="mt-8 bg-gray-800 border border-border rounded-2xl shadow-lg p-6 flex flex-col items-start md:items-center justify-between hover:shadow-xl transition-shadow duration-300">
        <div>
            ...
            <div className="space-y-4">
              {bookings.map((booking) => (
                <Link href={`/rooms/${booking.roomId._id}`} key={String(booking._id)} className="block">
                  <div className="bg-gray-800 rounded-lg shadow-md shadow-purple-500/20  p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-purple-500 border-2 hover:shadow-lg transition-shadow duration-300 cursor-pointer">
